...
public class Metalgreymon_OverFlame extends AbstractDynamicCard {
    public static final String ID = AgumonMod.makeID(Metalgreymon_OverFlame.class.getSimpleName());
    public static final String IMG = makeAttackCardPath(Metalgreymon_OverFlame.class.getSimpleName() + ".png");
    ...
    public void renderCardPreviewInSingleView(SpriteBatch sb) {
        UI_CardsPreview.MyRenderCardsPreviewInSingleView(sb, "Flame", this.upgraded, 2);
    }
    ...
    public AbstractCard makeCopy() {
        return new Metalgreymon_OverFlame();
    }
}