...
public class Wargreymon_Claw extends CustomCard {
    public static final String ID = AgumonMod.makeID(Wargreymon_Claw.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = makeAttackCardPath(Wargreymon_Claw.class.getSimpleName() + ".png");
    ...
    public void renderCardPreviewInSingleView(SpriteBatch sb) {
        UI_CardsPreview.MyRenderCardsPreviewInSingleView(sb, "Claw", this.upgraded, 3);
    }
