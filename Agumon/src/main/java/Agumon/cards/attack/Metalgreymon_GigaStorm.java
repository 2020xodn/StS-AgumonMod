...
public class Metalgreymon_GigaStorm extends CustomCard {
    public static final String ID = AgumonMod.makeID(Metalgreymon_GigaStorm.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = makeAttackCardPath(Metalgreymon_GigaStorm.class.getSimpleName() + ".png");
    ...
    public void renderCardPreviewInSingleView(SpriteBatch sb) {
        UI_CardsPreview.MyRenderCardsPreviewInSingleView(sb, "Burst", this.upgraded, 2);
    }
    ...
    public AbstractCard makeCopy() {
        return new Metalgreymon_GigaStorm();
    }
}
