...
public class Wargreymon_Gaia2 extends CustomCard {
    public static final String ID = AgumonMod.makeID(Wargreymon_Gaia2.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = makeAttackCardPath(Wargreymon_Gaia2.class.getSimpleName() + ".png");
    ...
    public void renderCardPreviewInSingleView(SpriteBatch sb) {
        UI_CardsPreview.MyRenderCardsPreviewInSingleView(sb, "Burst", this.upgraded, 3);
    }
