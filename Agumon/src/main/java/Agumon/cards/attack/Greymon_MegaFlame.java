...
public class Greymon_MegaFlame extends AbstractDynamicCard {
    public static final String ID = AgumonMod.makeID(Greymon_MegaFlame.class.getSimpleName());
    public static final String IMG = makeAttackCardPath(Greymon_MegaFlame.class.getSimpleName() + ".png");
    ...
    public void renderCardPreviewInSingleView(SpriteBatch sb) {
        UI_CardsPreview.MyRenderCardsPreviewInSingleView(sb, "Flame", this.upgraded, 1);
    }
