...
public class Agumon_BabyBurner extends CustomCard {
    public static final String ID = AgumonMod.makeID(Agumon_BabyBurner.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = makeAttackCardPath(Agumon_BabyBurner.class.getSimpleName() + ".png");
    ...
    public void renderCardPreviewInSingleView(SpriteBatch sb) {
        UI_CardsPreview.MyRenderCardsPreviewInSingleView(sb, "Burst", this.upgraded, 0);
    }
