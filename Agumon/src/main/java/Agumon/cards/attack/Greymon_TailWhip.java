...
public class Greymon_TailWhip extends CustomCard {
    public static final String ID = AgumonMod.makeID(Greymon_TailWhip.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = makeAttackCardPath(Greymon_TailWhip.class.getSimpleName() + ".png");
    ...
    public void renderCardPreviewInSingleView(SpriteBatch sb) {
        UI_CardsPreview.MyRenderCardsPreviewInSingleView(sb, "FuryClaw", this.upgraded, 1);
    }
