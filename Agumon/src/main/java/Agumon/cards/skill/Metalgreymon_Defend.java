...
public class Metalgreymon_Defend extends AbstractDynamicCard {
    public static final String ID = AgumonMod.makeID(Metalgreymon_Defend.class.getSimpleName());
    public static final String IMG = makeSkillCardPath(Metalgreymon_Defend.class.getSimpleName() + ".png");
    ...
    public void renderCardPreviewInSingleView(SpriteBatch sb) {
        UI_CardsPreview.MyRenderCardsPreviewInSingleView(sb, "Defend", this.upgraded, 2);
    }
