...
public class Wargreymon_Defend extends AbstractDynamicCard {
    public static final String ID = AgumonMod.makeID(Wargreymon_Defend.class.getSimpleName());
    public static final String IMG = makeSkillCardPath(Wargreymon_Defend.class.getSimpleName() + ".png");
    ...
    public void renderCardPreviewInSingleView(SpriteBatch sb) {
        UI_CardsPreview.MyRenderCardsPreviewInSingleView(sb, "Defend", this.upgraded, 3);
    }
