...
public class UltimateDigivolution extends AbstractDynamicCard {

    public static final String ID = AgumonMod.makeID(UltimateDigivolution.class.getSimpleName());
    public static final String IMG = makePowerCardPath(UltimateDigivolution.class.getSimpleName() + ".png");
    ...
    private static int COST_COURAGE = 10;

    public UltimateDigivolution() {
    ...
    public boolean canUse(AbstractPlayer p, AbstractMonster m) {
        if (AbstractDungeon.getCurrRoom() instanceof MonsterRoomBoss || AbstractDungeon.getCurrRoom() instanceof MonsterRoomElite) {
            ...
            this.cantUseMessage = CardCrawlGame.languagePack.getCharacterString(Agumon.ID).TEXT[6];
        }
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        while(monsterList.hasNext()) {
            ...
            if (!monster.isDead && !monster.isDying) {
                addToBot(new ApplyPowerAction(monster, monster, new burnPower(monster, monster, 2, monster.type), 2));
            }
        }
    }
